...
const LicitameScrollbars = React.forwardRef((props, ref) => {
	ref = ref || createRef();
...
function mapStateToProps({ licitame }) {
	return {
		customScrollbars: licitame.settings.current.customScrollbars
	};
}

LicitameScrollbars.propTypes = {
...
LicitameScrollbars.defaultProps = {
	className: '',
	enable: true,
...
export default connect(mapStateToProps, null, null, { forwardRef: true })(withRouterAndRef(LicitameScrollbars));
